<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WritePost.aspx.cs" Inherits="Reader.WritePost" %>
    ...
    <form id="form1" runat="server">
        ...
        <main>
            <div class="editor">
                ...
                <button type="submit" id="postBtn" runat="server" onserverclick="postBtn_ServerClick">Post</button> 
            </div>
        </main>
    </form>
    <script>
